...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--out", type=Path, default=Path("final_prompt.txt"),
                   help="最終プロンプトの出力先")
